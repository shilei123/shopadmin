    	...
    	<div class="admin-content-body">
      		<div class="am-g">
      			<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">订单确认</strong>/<small>根据库存是否足够拆分子订单</small>
				</div>
...
<script type="text/javascript">
	$(function() {
		$('#modalTitle').text("确认订单(" + $('#orderCode').val() + ")");
		//$('#orderId').val(id);
		//$('#operate').val("confirm");
		queryOrderGoods();
	});
...
//				writeHidden(data);
	...
	$('#confirmBtn').click(function() {
		var val = $('#operate').val();
		var data = {"order.id":$('#orderId').val()};
		//var url = path_ + "/view/shop/order/orderDetail!queryConfirmOrder.action";
		$.ajax({
			type : "POST",
			url : url,
			data : data,
