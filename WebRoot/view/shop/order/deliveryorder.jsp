...
var setGoodsInfo = function(goodsList){
	...
	if(goodsList[0]==undefined || goodsList[0]==null){
		...
		for (var i in goodsList) {
			...
			html += "<th>小计</th>";
			html += "</tr><tr>";
			html += "<td style='width:10%;'><div><span class=''><a href='javascript:void(0);' target='_blank'><img src=''/>" + "缺少主图字段，暂未关联图片" + "</a></span></div></td>";
...
var setAddressInfo = function(addressMap){
	...
	if(addressMap==null || addressMap==undefined || addressMap.deliveryRecordId==null || addressMap.deliveryRecordId==undefined){
		...
		html += "<ul>";
		html += "<li>收货人姓名：<span id='recName'>" + addressMap.name + "</span></li>";
		html += "<li>收货人手机：<span id='phone'></span>" + addressMap.phoneNum + "</li>";
		html += "<li>邮编：<span id='postCode'>" + addressMap.postNum + "</span></li>";
		html += "<li>收货地址：<span id='province'>" + addressMap.province + "</span><span id='city'>" + addressMap.city + "</span><span id='county'>" + addressMap.county + "</span></li>";
		html += "<li>详细地址：<span id='addressDetail'>" + addressMap.addressDetail + "</span></li>";
		html += "</ul>";
	}
