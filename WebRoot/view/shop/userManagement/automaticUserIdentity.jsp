			...
			<div class="admin-content-body">
				<div class="am-cf am-padding am-padding-bottom-0">
					<div class="am-fl am-cf">
						<strong class="am-text-primary am-text-lg">实名认证审核</strong> / <small>实名认证的自动认证、查看</small>
					</div>
				</div>
				<hr>
				<div class="am-g">
...
<script type="text/javascript" src="${path }/view/js/userManagement_automaticUserIdentity.js"></script>
</html>