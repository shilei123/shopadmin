							...
							<div class="am-panel-bd am-collapse am-in frame-search-panel"id="collapse-panel-1">
								<table id="from_query" class="frame-query-table" border="0" bordercolor="black">
									...
									<td class="query_title" style="width:100px;">账户状态：</td>
										...
										<td class="query_title" style="width:100px;">提现状态：</td>
										<td>
										<select id="tixianStatus" name="queryParams.tixianStatus" data-am-selected="{btnWidth: '164px'}">
										</select>
										</td>
										<td class="query_title" style="width:50px;">身份证状态：</td>
										<td>
										<select id="identityStatus" name="queryParams.identityStatus" data-am-selected="{btnWidth: '153px'}">
										</select>
										</td>
										<td colspan="1" >
						...
						<table class="am-table am-table-bordered am-table-striped am-table-hover" id="couponListTable">
							<thead>
								<tr>
									...
									<th width="8%" field="tixianStatus">提现状态</th>
