			...
			<div class="admin-content-body">
				<div class="am-cf am-padding am-padding-bottom-0">
					<div class="am-fl am-cf">
						<strong class="am-text-primary am-text-lg">维修管理</strong> / <small>维修商品的查看</small>
					</div>
				</div>
				<hr>
				<div class="am-g">
							...
							<div class="am-panel-bd am-collapse am-in frame-search-panel"id="collapse-panel-1">
								<table id="from_query" class="frame-query-table" border="0" bordercolor="black">
									<tr>
										...
										<td width="200px">
										<input type="hidden" name="queryParams.billType" value="<%=com.sunchin.shop.admin.dict.BillTypeEnum.REPAIRGOODS.getCode()%>"/>
...
<script type="text/javascript" src="${path }/view/js/alterService_repairGoods.js"></script>
</html>