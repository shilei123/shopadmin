			...
			<div class="admin-content-body">
				<div class="am-cf am-padding am-padding-bottom-0">
					<div class="am-fl am-cf">
						<strong class="am-text-primary am-text-lg">商品选择</strong> / <small>商品的选择、查询</small>
					</div>
				</div>
				<hr>
				<div class="am-g">
						...
						<div class="am-panel am-panel-primary">
							...
							<div class="am-panel-bd am-collapse am-in frame-search-panel"id="collapse-panel-1">
								<table id="from_query" class="frame-query-table" border="0" bordercolor="black">
									<tr>
										<td class="query_title" >商品名称：</td>
										<td><input name="queryParams.goodsName" class="am-form-field"/></td>
									</tr>
								</table>
							</div>
						</div>
				...
				<div class="am-g">
					<div class="am-u-sm-12 page-table-main">
						<table class="am-table am-table-bordered am-table-striped am-table-hover" id="goodsListTable">
				     		<thead>
								<tr>
