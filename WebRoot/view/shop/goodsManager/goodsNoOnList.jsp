			...
			<div class="admin-content-body">
				<div class="am-cf am-padding am-padding-bottom-0">
					<div class="am-fl am-cf">
						<strong class="am-text-primary am-text-lg">待发布商品</strong> / <small>待发布商品</small>
					</div>
				</div>
				<hr>
				<div class="am-g">
							...
							<div class="am-panel-bd am-collapse am-in frame-search-panel" id="collapse-panel-1">
								<table id="from_query" class="frame-query-table" border="0" bordercolor="black">
									<tr>
										...
										<td>&nbsp;<button type="button" id="queryBtn" class="am-btn am-btn-primary frame-search-button">查询</button></td>
									</tr>
								</table>
							</div>
						</div>
...
<script type="text/javascript" src="${path }/view/js/goodsManager_goodsNoOnList.js"></script>
</html>