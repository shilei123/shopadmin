			...
			<div class="admin-content-body">
				<div class="am-cf am-padding am-padding-bottom-0">
					<div class="am-fl am-cf">
						<strong class="am-text-primary am-text-lg">已下架商品</strong> / <small>商品的编辑、重新上架</small>
					</div>
				</div>
				<hr>
				<div class="am-g">
...
<script type="text/javascript" src="${path }/view/js/goodsManager_soldOutList.js"></script>
</html>