...
var formatterAction = function(value, row) {
	...
	if(row["auditSts"]=="1") {
		html += "&nbsp;&nbsp;<a href='javascript:void(0)' class='am-text-success' onclick='passGoods(\""+ row["id"]+ "\")'><i class='am-icon-check-square-o'></i>通过</a>";
		html += "&nbsp;&nbsp;<a href='javascript:void(0)' class='am-text-warning' onclick='noPassGoods(\""+ row["id"]+ "\")'><i class='am-icon-minus-square-o'></i>不通过</a>";
	}
	html += "&nbsp;&nbsp;<a href='javascript:void(0)' class='am-text-danger' onclick='deleteGoods(\""+ row["id"]+ "\")'><i class='am-icon-remove'></i>删除</a>";
	html += "</div>";
	return html;
};
