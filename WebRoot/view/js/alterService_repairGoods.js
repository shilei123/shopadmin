...
var formatterAction = function(value, row) {
	...
	if(row.billStatus == "通过"){
		html += "&nbsp;&nbsp;<a href='javascript:void(0)'  onclick='deliverGoods(\""+ row["id"]+ "\")'><span class='am-icon-paper-plane-o'></i>发货</a>";
	}
	html += "</div>";
	return html;
};
...
$("#savePassBtn").click(function(){
	...
	$.ajax({
		type : "POST",
		url : path_ + "/view/shop/alterService/after!passRepairGoods.action",
		data : data,
		dataType : "json",
