	...
	<div class="admin-content">
    	<div class="admin-content-body">
      		<div class="am-cf am-padding am-padding-bottom-0">
        		<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">机构维护</strong> / <small>机构新增、修改、删除，机构参数配置、查看（easyui tree和amazeUI结合使用）</small></div>
      		</div>
      		<hr>
	      	<div class="am-g">
		      	<div class="am-u-sm-12">
					<div class="am-btn-toolbar frame-div-paddbottom20">
			            <div class="am-btn-group am-btn-group-sm">
			              ...
			              <!-- <button type="button" class="am-btn am-btn-default"><span class="am-icon-archive"></span> 刷新</button>
			              <button type="button" class="am-btn am-btn-default"><span class="am-icon-archive"></span> 关闭</button> -->
			            </div>
		          	</div>
				</div>
		  	</div>
						...
						<tr>
							<td width="20%" valign="top">
								<div class="am-panel am-panel-default">
							  		<div class="am-panel-hd">网体机构列表</div>
							...
							<td>
								<div class="am-panel am-panel-default">
							  		<div class="am-panel-hd">网体机构信息</div>
											...
											<tr>
												<td width="150">
													<div class="frame-div-padd10">
								        				<label for="inp_parentAgencyName" class="am-form-label">上级机构名称：</label>
								        			</div>
												</td>
												<td>
													<div class="frame-div-padd10">
  	...
  	<script type="text/javascript" src="${path }/view/js/agency_agencymanager.js"></script>
