...
.c2 a.home{width:66px;background:url("<%=request.getContextPath() %>/images/404/02.png");padding-left:30px}
.c2 a.home:hover{background:url("<%=request.getContextPath() %>/images/404/02.png") 0 -24px}
.c2 a.home:active{background:url("<%=request.getContextPath() %>/images/404/02.png") 0 -48px}
.c2 a.re{width:66px;background:url("<%=request.getContextPath() %>/images/404/03.png");padding-left:30px}
.c2 a.re:hover{background:url("<%=request.getContextPath() %>/images/404/03.png") 0 -24px}
.c2 a.re:active{background:url("<%=request.getContextPath() %>/images/404/03.png") 0 -48px}
.c2 a.sr{width:153px;background:url("<%=request.getContextPath() %>/images/404/04.png");padding-left:28px}
.c2 a.sr:hover{background:url("<%=request.getContextPath() %>/images/404/04.png") 0 -24px}
.c2 a.sr:active{background:url("<%=request.getContextPath() %>/images/404/04.png") 0 -48px}
...
<div class="bg">
	<div class="cont">
		<div class="c1"><img src="<%=request.getContextPath() %>/images/404/01.png" class="img1" /></div>
		<h2>哎呀…您访问的页面发生异常!</h2>
		<div class="c2">
